...
function newtheme_scripts() {
    wp_enqueue_style( 'newtheme-normolize', get_template_directory_uri() . '/css/normalize.css', array(), _S_VERSION );
	wp_enqueue_style( 'newtheme-style', get_template_directory_uri() . '/css/main.css', array(), _S_VERSION );


	wp_enqueue_script( 'newtheme-common-js', get_template_directory_uri() . '/js/common.js', array(), _S_VERSION, true );
...
function add_menu_parent_icon( $items ) {
    ...
    foreach ( $items as $item ) {
        if ( in_array( 'menu-item-has-children' , $item->classes) ) {
            ...
            $item->title = '<span>' . $item->title . '</span><img src="/wp-content/uploads/icons/chevron-down.svg" alt="icon" class="icon icon--accent">';
        }
    }
    return $items;
}
